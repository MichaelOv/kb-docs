...
| :--------------------------: | :----------: | :----------: | :-------: | :-------: |
|          0 Stunden           | **Dringend** |    _Hoch_    |  Normal   |  Niedrig  |
|          8 Stunden           | **Dringend** | **Dringend** |  _Hoch_   |  Normal   |
...
|           8H            |     _NIEDRIG_      |   **NORMAL**   |
|           16H           |     _NIEDRIG_      |    **HOCH**    |
|           24h           |     _NIEDRIG_      |  **DRINGEND**  |
|           8H            |      _NORMAL_      |    **HOCH**    |
|           16H           |      _NORMAL_      |  **DRINGEND**  |
|           24h           |       _HOCH_       |  **DRINGEND**  |
...
5. Erstellte Hotfixes werden nur im JIRA-Ticket hinterlegt.
   Format: JIRA-ID_COMMIT-ID.zip
   Beispiel: ID-1234_913ef2.zip
