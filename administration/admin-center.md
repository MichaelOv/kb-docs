...
[https://demo.i-doit.com/admin/](https://demo.i-doit.com/admin/)
...
Bei einem Klick auf den Bereich **Support** wird das <[help.i-doit.com](http://help.i-doit.com)\></https.help.i-doit.com> in einem neuen Tab geöffnet. Dort können Sie Tickets erstellen und den Bearbeitungsstand einsehen.
...
| admin.active\_license\_distribution | 1   |     |
...
| cmdb.limits.connector-lists-assigned\_connectors | 5   |     |
...
| cmdb.object.title.cable-prefix | KABEL\_DEFAULT\_ |     |
...
| debug\_bar.storeDirectory | /tmp/idoit\_debugbar |     |
| debug-bar.enabled | 1   |     |
...
| login.tenantlist.sortby | isys\_mandator\_\_sort |     |
| maxlength.dialog\_plus | 110 |     |
...
| system.email.from | [i-doit@example-domain.int](mailto:i-doit@example-domain.int) |     |
| [system.email.name](http://system.email.name) | \-  |     |
